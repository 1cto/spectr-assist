...
export function FeatureEditor({ value: featureContent, onChange: setFeatureContent, sessionId }: FeatureEditorProps) {
  ...
  return (
    <div className="flex flex-col h-full bg-white rounded-2xl shadow-[0_4px_24px_rgba(0,0,0,0.08)]">
      <div className="p-4 bg-white flex items-center justify-between rounded-t-2xl border-b" style={{ borderColor: 'rgba(0, 0, 0, 0.08)' }}>
      ...
      <div className="p-4 bg-white rounded-b-2xl border-t" style={{ borderColor: 'rgba(0, 0, 0, 0.08)' }}>
